...
/**
 * This class defines the structure of the 'request_status' table.
 *
 *
 *
...
class RequestStatusTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.nlwCirculationPlugin.lib.model.map.RequestStatusTableMap';
	...
	{
    $this->addRelation('request', 'request', RelationMap::ONE_TO_MANY, array('id' => 'status', ), null, null);
	} // buildRelations()
