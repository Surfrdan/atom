...
abstract class BaseRequestStatuses implements ArrayAccess
{
  const
    ...
    ID = 'request_statuses.ID',
    STATUS = 'request_statuses.STATUS',
    SERIAL_NUMBER = 'request_statuses.SERIAL_NUMBER';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitRequestStatuses::ID);
    $criteria->addSelectColumn(QubitRequestStatuses::STATUS);
    $criteria->addSelectColumn(QubitRequestStatuses::SERIAL_NUMBER);

    return $criteria;
  }

  protected static
    $requestStatusess = array();
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$requestStatusess[$key]))
    {
      $requestStatuses = new QubitRequestStatuses;

      $requestStatuses->keys = $keys;
      $requestStatuses->row = $row;

      $requestStatuses->new = false;

      self::$requestStatusess[$key] = $requestStatuses;
    }

    return self::$requestStatusess[$key];
  }

  public static function clearCache()
  {
    self::$requestStatusess = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRequestStatuses::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRequestStatuses', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitRequestStatuses::ID, $id);
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitRequestStatuses::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRequestStatuses::DATABASE_NAME)->getTable(QubitRequestStatuses::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitRequestStatuses::ID, $this->id);
  ...
  {
    $criteria->add(QubitRequests::STATUS, $id);
