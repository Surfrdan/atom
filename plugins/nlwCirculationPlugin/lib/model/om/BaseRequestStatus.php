...
abstract class BaseRequestStatus implements ArrayAccess
{
  const
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$requestStatuss[$key]))
    {
      $requestStatus = new QubitRequestStatus;

      $requestStatus->keys = $keys;
      $requestStatus->row = $row;

      $requestStatus->new = false;

      self::$requestStatuss[$key] = $requestStatus;
    }

    return self::$requestStatuss[$key];
  }

  public static function clearCache()
  {
    self::$requestStatuss = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRequestStatus::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRequestStatus', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitRequestStatus::ID, $id);
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitRequestStatus::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRequestStatus::DATABASE_NAME)->getTable(QubitRequestStatus::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitRequestStatus::ID, $this->id);
  ...
  {
    $criteria->add(QubitRequest::STATUS, $id);
