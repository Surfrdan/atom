...
abstract class BaseRequestType implements ArrayAccess
{
  const
    ...
    SERIAL_NUMBER = 'request_type.SERIAL_NUMBER';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitRequestType::ID);
    $criteria->addSelectColumn(QubitRequestType::TYPE);
    $criteria->addSelectColumn(QubitRequestType::SERIAL_NUMBER);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$requestTypes[$key]))
    {
      $requestType = new QubitRequestType;

      $requestType->keys = $keys;
      $requestType->row = $row;

      $requestType->new = false;

      self::$requestTypes[$key] = $requestType;
    }

    return self::$requestTypes[$key];
  }

  public static function clearCache()
  {
    self::$requestTypes = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRequestType::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRequestType', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitRequestType::ID, $id);
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitRequestType::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRequestType::DATABASE_NAME)->getTable(QubitRequestType::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitRequestType::ID, $this->id);
  ...
  {
    $criteria->add(QubitRequest::REQUEST_TYPE_ID, $id);
