...
abstract class BaseRequests implements ArrayAccess
{
  const
    ...
    ID = 'requests.ID',
    REQUEST_TYPE_ID = 'requests.REQUEST_TYPE_ID',
    PATRON_BARCODE = 'requests.PATRON_BARCODE',
    COLLECTION_DATE = 'requests.COLLECTION_DATE',
    EXPIRY_DATE = 'requests.EXPIRY_DATE',
    PATRON_NOTES = 'requests.PATRON_NOTES',
    STAFF_NOTES = 'requests.STAFF_NOTES',
    STATUS = 'requests.STATUS',
    CREATED_AT = 'requests.CREATED_AT',
    UPDATED_AT = 'requests.UPDATED_AT',
    SERIAL_NUMBER = 'requests.SERIAL_NUMBER';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitRequests::ID);
    $criteria->addSelectColumn(QubitRequests::REQUEST_TYPE_ID);
    $criteria->addSelectColumn(QubitRequests::PATRON_BARCODE);
    $criteria->addSelectColumn(QubitRequests::COLLECTION_DATE);
    $criteria->addSelectColumn(QubitRequests::EXPIRY_DATE);
    $criteria->addSelectColumn(QubitRequests::PATRON_NOTES);
    $criteria->addSelectColumn(QubitRequests::STAFF_NOTES);
    $criteria->addSelectColumn(QubitRequests::STATUS);
    $criteria->addSelectColumn(QubitRequests::CREATED_AT);
    $criteria->addSelectColumn(QubitRequests::UPDATED_AT);
    $criteria->addSelectColumn(QubitRequests::SERIAL_NUMBER);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$requestss[$key]))
    {
      $requests = new QubitRequests;
      ...
      self::$requestss[$key] = $requests;
    }

    return self::$requestss[$key];
  }

  public static function clearCache()
  {
    self::$requestss = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRequests::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRequests', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitRequests::ID, $id);
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitRequests::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRequests::DATABASE_NAME)->getTable(QubitRequests::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitRequests::ID, $this->id);
  ...
  {
    $criteria->addJoin(QubitRequests::ID, QubitObject::ID);
  ...
  {
    $criteria->addJoin(QubitRequests::REQUEST_TYPE_ID, QubitRequestTypes::ID);

    return $criteria;
  }

  public static function addJoinrequestStatusesCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitRequests::STATUS, QubitRequestStatuses::ID);
