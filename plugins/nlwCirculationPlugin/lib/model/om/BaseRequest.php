...
abstract class BaseRequest implements ArrayAccess
{
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitRequest::UPDATED_AT);
    $criteria->addSelectColumn(QubitRequest::SERIAL_NUMBER);
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitRequest::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitRequest', $options);
  }
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitRequest::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitRequest::DATABASE_NAME)->getTable(QubitRequest::TABLE_NAME);
  }
  ...
  public static function addJoinrequestStatusCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitRequest::STATUS, QubitRequestStatus::ID);
